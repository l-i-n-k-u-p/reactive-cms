    ...
    <div>
        ...
        <div slot-scope="{ commands, isActive }" class="editor-button-wrapper">
            ...
            <DropdownSlot class="dropdown-wrapper" icon="format_color_text">
                <button v-for="(itemColor) in colors" :class="{ 'is-active': isActive.textcolor({ color: itemColor }) }" @click="commands.textcolor({ color: itemColor })">
            ...
            <button :class="{ 'is-active': isActive.paragraph({ textAlign: 'justify' }) }" @click="commands.paragraph({ textAlign: 'justify' })">
...
.ProseMirror:focus {
    border-bottom: 1px solid #036dad;
}
